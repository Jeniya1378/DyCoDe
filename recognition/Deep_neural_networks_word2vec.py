...
if dataset_selection == "4":
    CNN_w2v_model_fit = CNN_w2v_model.fit(X_tra, y_tra, class_weight=class_weights_dict,batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
else:
    CNN_w2v_model_fit = CNN_w2v_model.fit(X_tra, y_tra, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
...
if dataset_selection == "4":
    RNN_w2v_model_fit = RNN_w2v_model.fit(X_tra, y_tra, class_weight=class_weights_dict,batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
else:
    RNN_w2v_model_fit = RNN_w2v_model.fit(X_tra, y_tra, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
...
if dataset_selection == "4":
    LSTM_w2v_model_fit = LSTM_w2v_model.fit(X_tra, y_tra,class_weight=class_weights_dict, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
else:
    LSTM_w2v_model_fit = LSTM_w2v_model.fit(X_tra, y_tra, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
...
if dataset_selection == "4":
    Bi_LSTM_w2v_model_fit = Bi_LSTM_w2v_model.fit(X_tra, y_tra, class_weight=class_weights_dict,batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
else:
    Bi_LSTM_w2v_model_fit = Bi_LSTM_w2v_model.fit(X_tra, y_tra, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
...
if dataset_selection == "4":
    GRU_w2v_model_fit = GRU_w2v_model.fit(X_tra, y_tra, class_weight=class_weights_dict,batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
else:
    GRU_w2v_model_fit = GRU_w2v_model.fit(X_tra, y_tra, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])

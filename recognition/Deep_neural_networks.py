...
if dataset_selection == "4":
    CNN_model_fit = CNN_model.fit(X_tra, y_tra, class_weight=class_weights_dict,batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
else:
    CNN_model_fit = CNN_model.fit(X_tra, y_tra,batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
...
RNN_model.summary()
if dataset_selection == "4":
    RNN_model_fit = RNN_model.fit(X_tra, y_tra,class_weight=class_weights_dict, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
else:
    RNN_model_fit = RNN_model.fit(X_tra, y_tra, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
...
LSTM_model.summary()
if dataset_selection == "4":
    LSTM_model_fit = LSTM_model.fit(X_tra, y_tra,class_weight=class_weights_dict, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
else:
    LSTM_model_fit = LSTM_model.fit(X_tra, y_tra, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
...
if dataset_selection == "4":
    Bi_LSTM_model_fit = Bi_LSTM_model.fit(X_tra, y_tra,class_weight=class_weights_dict, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
else:
    Bi_LSTM_model_fit = Bi_LSTM_model.fit(X_tra, y_tra, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
...
GRU_model.summary()
if dataset_selection == "4":
    GRU_model_fit = GRU_model.fit(X_tra, y_tra, class_weight=class_weights_dict,batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
else:
    GRU_model_fit = GRU_model.fit(X_tra, y_tra, batch_size=batch_size2, epochs=num_epochs, validation_data=(X_val, y_val), callbacks=[early, f1_callback])
